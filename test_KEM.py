...
def parse_options(is_train=True):
    ...
    parser.add_argument(
        '-opt', type=str, default='yml/KEM_test.yml', required=False, help='Path to option YAML file.')
    parser.add_argument(
        '--launcher',
...
def main():
    ...
    # torch.save(model.net_g.kernel_extra.state_dict(), 'kernel_extra.pth')
    # torch.save(model.net_g.flow.state_dict(),'flow.pth')
